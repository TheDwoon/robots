...
public class Textures {
	...
	private static final class RobotPaintManager {
		...
		private static final Paint[] AVAILABLE_ROBOT_PAINTS = {
				// 500
				Color.web("#F44336"), Color.web("#009688"), Color.web("#3F51B5"),
				Color.web("#FFEB3B"), Color.web("#E91E63"), Color.web("#4CAF50"),
				Color.web("#2196F3"), Color.web("#FFC107"), Color.web("#9C27B0"),
				Color.web("#8BC34A"), Color.web("#03A9F4"), Color.web("#FF9800"),
				Color.web("#673AB7"), Color.web("#CDDC39"), Color.web("#00BCD4"),
				Color.web("#FF5722"),

				// 200
				Color.web("#EF9A9A"), Color.web("#80CBC4"), Color.web("#9FA8DA"),
				Color.web("#FFF59D"), Color.web("#F48FB1"), Color.web("#A5D6A7"),
				Color.web("#90CAF9"), Color.web("#FFE082"), Color.web("#CE93D8"),
				Color.web("#C5E1A5"), Color.web("#81D4FA"), Color.web("#FFCC80"),
				Color.web("#B39DDB"), Color.web("#E6EE9C"), Color.web("#80DEEA"),
				Color.web("#FFAB91"),

				// 900
				Color.web("#B71C1C"), Color.web("#004D40"), Color.web("#1A237E"),
				Color.web("#F57F17"), Color.web("#880E4F"), Color.web("#1B5E20"),
				Color.web("#0D47A1"), Color.web("#FF6F00"), Color.web("#4A148C"),
				Color.web("#33691E"), Color.web("#01579B"), Color.web("#E65100"),
				Color.web("#311B92"), Color.web("#827717"), Color.web("#006064"),
				Color.web("#BF360C") };
		...
		public Paint getPaint(Robot robot) {
			Integer paintIndex = robotPaintMap
					.computeIfAbsent(robot.getUUID(), k -> getNextAvailablePaintIndex());
